...
db.courses.insert([
    ...
    { name: "COMPSCI 250", credits: 3, prereqs:[{and:"COMPSCI 150"}]},
    { name: "COMPSCI 250", credits: 3, prereqs:[{or:["MATH 116","MATH 211"]}]},
    { name: "COMPSCI 251", credits: 3, prereqs:[{and:"COMPSCI 250"}, {or:["MATH 116", "MATH 211"]}]},
    { name: "COMPSCI 315", credits: 3, prereqs:[{and:"COMPSCI 250"}, {or:["MATH 116", "MATH 211"]}]},
    { name: "COMPSCI 317", credits: 3, prereqs:[{and:"COMPSCI 250"}, {or:["MATH 221, MATH 226, MATH 231"]}]},
    { name: "COMPSCI 337", credits: 3, prereqs:[{and:"COMPSCI 251"}]},
    { name: "COMPSCI 351", credits: 3, prereqs:[{and:"COMPSCI 251"}, {or:["MATH 116", "MATH 211"]}]},
    { name: "COMPSCI 361", credits: 3, prereqs:[{and:"COMPSCI 351"}, {and:"GER ENGLISH"}]},
    { name: "COMPSCI 395", credits: 3, prereqs:[{and:"SOPHMORE STATUS"}]},
    { name: "COMPSCI 417", credits: 3, prereqs:[{and:"JUNIOR STATUS"}, {and:"COMPSCI 317"}, {or:["MATH 221", "MATH 232"]}]},
    { name: "COMPSCI 431", credits: 3, prereqs:[{and:"JUNIOR STATUS"}, {and:"COMPSCI 351"}]},
    { name: "COMPSCI 458", credits: 3, prereqs:[{and:"JUNIOR STATUS"}, {or:["COMPSCI 315", "ELECENG 367", "ELECENG 354"]}]},
    { name: "COMPSCI 520", credits: 3, prereqs:[{and:"JUNIOR STATUS"}, {or:["COMPSCI 315", "COMPSCI 458", "ELECENG 367"]}]},
    { name: "COMPSCI 535", credits: 3, prereqs:[{and:"JUNIOR STATUS"}, {and:"COMPSCI 317"}, {and:"COMPSCI 351"}]},
    { name: "COMPSCI 537", credits: 3, prereqs:[{and:"JUNIOR STATUS"}, {and:"COMPSCI 337"}, {or:["COMPSCI 458", "ELECENG 458"]}]},
    { name: "COMPSCI 595", credits: 4, prereqs:[{and:"SENIOR STATUS"}, {and:"COMPSCI 361"}, {and:"COMPSCI 458"}, {and:"COMPSCI 535"}, {and:"COMPSCI 537"}]},
    { name: "EAS 200", credits: 1, prereqs:[]},
    { name: "ELECENG 354", credits: 3, prereqs:[{or:["COMPSCI 240", "COMPSCI 250"]}]},

    // math requirements
    { name: "MATH 211", credits: 4, prereqs:[{and:'MATH 116'}]},
    { name: "MATH 117", credits: 2, prereqs:[{and:"MATH 116"}]},
